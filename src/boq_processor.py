...
class BoQProcessor:
    def __init__(self, catalog_dir: str, gemini_api_key: str):
    ...
    def process_boq_line(self, boq_line: str) -> dict:
        """
        ...
        try:
            ...
            pdf_path = Path(self.catalog_dir) / pdf_name
    ...
    def _get_product_price_tables(self, doc: fitz.Document, start_page: int, 
                                end_page: Optional[int], start_y: float, 
                                end_y: Optional[float]) -> List[dict]:
